...
func NewListAlertsRequest(server string, params *ListAlertsParams) (*http.Request, error) {
	...
	basePath := fmt.Sprintf("/v1/alerts")
	if basePath[0] == '/' {
		basePath = basePath[1:]
	}
...
func NewGetAlertRequest(server string, id string) (*http.Request, error) {
	...
	basePath := fmt.Sprintf("/v1/alerts/%s", pathParam0)
	if basePath[0] == '/' {
		basePath = basePath[1:]
	}
...
func NewMitigateIncidentRequestWithBody(server string, id string, contentType string, body io.Reader) (*http.Request, error) {
	...
	basePath := fmt.Sprintf("/v1/incidents/%s/mitigate", pathParam0)
	if basePath[0] == '/' {
		basePath = basePath[1:]
	}
...
func NewResolveIncidentRequestWithBody(server string, id string, contentType string, body io.Reader) (*http.Request, error) {
	...
	basePath := fmt.Sprintf("/v1/incidents/%s/resolve", pathParam0)
	if basePath[0] == '/' {
		basePath = basePath[1:]
	}
...
func NewListAlertRequest(server string, incidentId string, params *ListAlertParams) (*http.Request, error) {
	...
	basePath := fmt.Sprintf("/v1/incidents/%s/alerts", pathParam0)
	if basePath[0] == '/' {
		basePath = basePath[1:]
	}
...
type ClientWithResponsesInterface interface {
	...
	// ListAlerts request
	ListAlertsWithResponse(ctx context.Context, params *ListAlertsParams) (*ListAlertsResponse, error)

	// GetAlert request
	GetAlertWithResponse(ctx context.Context, id string) (*GetAlertResponse, error)
	...
	// MitigateIncident request  with any body
	MitigateIncidentWithBodyWithResponse(ctx context.Context, id string, contentType string, body io.Reader) (*MitigateIncidentResponse, error)

	// ResolveIncident request  with any body
	ResolveIncidentWithBodyWithResponse(ctx context.Context, id string, contentType string, body io.Reader) (*ResolveIncidentResponse, error)
	...
	// ListAlert request
	ListAlertWithResponse(ctx context.Context, incidentId string, params *ListAlertParams) (*ListAlertResponse, error)

	// AttachAlert request  with any body
	AttachAlertWithBodyWithResponse(ctx context.Context, incidentId string, contentType string, body io.Reader) (*AttachAlertResponse, error)
...
func (c *ClientWithResponses) ListAlertsWithResponse(ctx context.Context, params *ListAlertsParams) (*ListAlertsResponse, error) {
	rsp, err := c.ListAlerts(ctx, params)
	if err != nil {
		return nil, err
	}
...
func (c *ClientWithResponses) GetAlertWithResponse(ctx context.Context, id string) (*GetAlertResponse, error) {
	rsp, err := c.GetAlert(ctx, id)
	if err != nil {
		return nil, err
	}
...
func (c *ClientWithResponses) MitigateIncidentWithBodyWithResponse(ctx context.Context, id string, contentType string, body io.Reader) (*MitigateIncidentResponse, error) {
	rsp, err := c.MitigateIncidentWithBody(ctx, id, contentType, body)
	if err != nil {
		return nil, err
	}
...
func (c *ClientWithResponses) ResolveIncidentWithBodyWithResponse(ctx context.Context, id string, contentType string, body io.Reader) (*ResolveIncidentResponse, error) {
	rsp, err := c.ResolveIncidentWithBody(ctx, id, contentType, body)
	if err != nil {
		return nil, err
	}
...
func (c *ClientWithResponses) ListAlertWithResponse(ctx context.Context, incidentId string, params *ListAlertParams) (*ListAlertResponse, error) {
	rsp, err := c.ListAlert(ctx, incidentId, params)
	if err != nil {
		return nil, err
	}
...
func (c *ClientWithResponses) AttachAlertWithBodyWithResponse(ctx context.Context, incidentId string, contentType string, body io.Reader) (*AttachAlertResponse, error) {
	rsp, err := c.AttachAlertWithBody(ctx, incidentId, contentType, body)
	if err != nil {
		return nil, err
	}
